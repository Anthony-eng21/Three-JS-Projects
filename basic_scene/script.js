...
// Sizes for our view port and size config object for our render and it's aspect ratio
const sizes = {
  width: 800,
  height: 600,
};
...
camera.position.z = 5; // just with this position we see a face of our cube and it looks like a square
camera.position.x = 1; 
camera.position.y = 1; 
scene.add(camera); 
